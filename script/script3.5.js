...
Ennemy = function(){
  ...
  var mat = new THREE.MeshPhongMaterial({color:Colors.red , specular:0Xffffff, skinning:0, shading:THREE.FlatShading})
  this.mesh = new THREE.Mesh(geom, mat);
  this.mesh.castShadow = true;
  this.angele = 0;
  this.dist = 0;
  ...
  function loop(){
    ...
    airplane.mesh.position.y -=game.planeFallSpeed*deltaTime*.0002;
    sea.moveWaves();
    sea.mesh.rotation.z +=.005;
    sky.mesh.rotation.z+=.01;
...
function updateEnergy(){
  ...
  camera.position.y +=
    ...
    game.planeCollisionSpeedX+=(0.1-game.planeCollisionSpeedX)*deltaTime*0.03;
    game.planeCollisionDisplacementX+=(0.1-game.planeCollisionDisplacementX)*deltaTime*0.01;

    game.planeCollisionSpeedY+=(0.1-game.planeCollisionSpeedX)*deltaTime*0.03;
    game.planeCollisionDisplacementY+=(0.1-game.planeCollisionDisplacementY)*deltaTime*0.01;
